...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Right.setBackground(new java.awt.Color(176, 137, 104));
        Right.setPreferredSize(new java.awt.Dimension(400, 500));

        jLabel5.setFont(new java.awt.Font("Helvetica Neue", 0, 10)); // NOI18N
        jLabel5.setIcon(new javax.swing.ImageIcon("/Users/admin/NetBeansProjects/LoginAndSignUp/src/icon/IMG_1384.PNG")); // NOI18N
        jLabel5.setMaximumSize(new java.awt.Dimension(200, 200));
        jLabel5.setMinimumSize(new java.awt.Dimension(200, 200));
        jLabel5.setPreferredSize(new java.awt.Dimension(326, 306));
        ...
        Left.setBackground(new java.awt.Color(237, 224, 212));
        Left.setMinimumSize(new java.awt.Dimension(400, 500));

        jLabel1.setFont(new java.awt.Font("Helvetica Neue", 1, 36)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(88, 47, 14));
        ...
        Loginbtn.setBackground(new java.awt.Color(176, 137, 104));
        Loginbtn.setFont(new java.awt.Font("Helvetica Neue", 0, 14)); // NOI18N
        Loginbtn.setForeground(new java.awt.Color(88, 47, 14));
       ...
       try{
           ...
           if("".equals(email.getText())){
               ...
               if(notFound == 1 && Password.equals(passDb)){
                    SchoolItemOrderingApp SchoolItemOrderingAppFrame = new SchoolItemOrderingApp();
                    SchoolItemOrderingAppFrame.setUser(fname);
                    SchoolItemOrderingAppFrame.setVisible(true);
                    SchoolItemOrderingAppFrame.pack();
                    SchoolItemOrderingAppFrame.setLocationRelativeTo(null); //center
       this.dispose();
               }else{
